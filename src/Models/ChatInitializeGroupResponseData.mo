...
module {
    /// The required-fields slice of ChatInitializeGroupResponseData — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ChatInitializeGroupResponseData as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        conversation_id : ?Text;
    };

    public type ChatInitializeGroupResponseData = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ChatInitializeGroupResponseData {
