...
module {
    ...
    public type VideoAllOfPromotedMetrics = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer VideoAllOfPromotedMetrics type
        public type JSON = {
            playback_0_count : ?Int;
            playback_100_count : ?Int;
            playback_25_count : ?Int;
        ...
        public func toJSON(value : VideoAllOfPromotedMetrics) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?VideoAllOfPromotedMetrics = ?json;
    }
}
