...
module {
    ...
    public type Get2ListsIdTweetsResponse = {
        data : ?[Tweet];
        errors : ?[Problem];
        includes : ?Expansions;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer Get2ListsIdTweetsResponse type
        public type JSON = {
            data : ?[Tweet];
            errors : ?[Problem];
            includes : ?Expansions;
        ...
        public func toJSON(value : Get2ListsIdTweetsResponse) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?Get2ListsIdTweetsResponse = ?json;
    }
}
