...
module {
    /// The required-fields slice of FilteredStreamingTweetResponseMatchingRulesInner — what `init` consumes.
    ...
    // it's an internal scaffold so we can express FilteredStreamingTweetResponseMatchingRulesInner as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        tag : ?Text;
    };

    public type FilteredStreamingTweetResponseMatchingRulesInner = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : FilteredStreamingTweetResponseMatchingRulesInner {
