...
module {
    /// The required-fields slice of TweetNonPublicMetrics — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetNonPublicMetrics as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        impression_count : ?Int;
    };

    public type TweetNonPublicMetrics = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetNonPublicMetrics {
