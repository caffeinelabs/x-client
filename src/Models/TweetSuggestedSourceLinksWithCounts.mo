...
module {
    /// The required-fields slice of TweetSuggestedSourceLinksWithCounts — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetSuggestedSourceLinksWithCounts as an
    ...
    public type TweetSuggestedSourceLinksWithCounts = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetSuggestedSourceLinksWithCounts {
