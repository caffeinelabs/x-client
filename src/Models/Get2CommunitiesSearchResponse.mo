...
module {
    /// The required-fields slice of Get2CommunitiesSearchResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express Get2CommunitiesSearchResponse as an
    ...
    public type Get2CommunitiesSearchResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : Get2CommunitiesSearchResponse {
