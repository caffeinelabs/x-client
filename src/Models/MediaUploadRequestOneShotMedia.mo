...
module {
    /// The required-fields slice of MediaUploadRequestOneShotMedia — what `init` consumes.
    ...
    // it's an internal scaffold so we can express MediaUploadRequestOneShotMedia as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type MediaUploadRequestOneShotMedia = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : MediaUploadRequestOneShotMedia {
