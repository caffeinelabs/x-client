...
module {
    /// The required-fields slice of PreviewImage — what `init` consumes.
    ...
    // it's an internal scaffold so we can express PreviewImage as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type PreviewImage = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : PreviewImage {
