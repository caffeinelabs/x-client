...
module {
    /// The required-fields slice of CashtagFields — what `init` consumes.
    ...
    // it's an internal scaffold so we can express CashtagFields as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type CashtagFields = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : CashtagFields {
