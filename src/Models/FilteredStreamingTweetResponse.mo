...
module {
    /// The required-fields slice of FilteredStreamingTweetResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express FilteredStreamingTweetResponse as an
    ...
    public type FilteredStreamingTweetResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : FilteredStreamingTweetResponse {
