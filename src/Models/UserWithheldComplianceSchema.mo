...
module {
    /// The required-fields slice of UserWithheldComplianceSchema — what `init` consumes.
    ...
    // it's an internal scaffold so we can express UserWithheldComplianceSchema as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type UserWithheldComplianceSchema = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : UserWithheldComplianceSchema {
