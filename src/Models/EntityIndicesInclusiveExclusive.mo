...
module {
    ...
    public type EntityIndicesInclusiveExclusive = {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer EntityIndicesInclusiveExclusive type
        public type JSON = {
            end : Int;
            start : Int;
        };
        ...
        public func toJSON(value : EntityIndicesInclusiveExclusive) : JSON = {
            end = value.end;
            start = value.start;
        };

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?EntityIndicesInclusiveExclusive {
            ?{
