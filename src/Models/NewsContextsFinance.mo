...
module {
    /// The required-fields slice of NewsContextsFinance — what `init` consumes.
    ...
    // it's an internal scaffold so we can express NewsContextsFinance as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        tickers : ?[Text];
    };

    public type NewsContextsFinance = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : NewsContextsFinance {
