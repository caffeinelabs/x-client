...
module {
    /// The required-fields slice of MetadataCreateRequestMetadata — what `init` consumes.
    ...
    // it's an internal scaffold so we can express MetadataCreateRequestMetadata as an
    ...
    public type MetadataCreateRequestMetadata = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : MetadataCreateRequestMetadata {
