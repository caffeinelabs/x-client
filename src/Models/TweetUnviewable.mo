...
module {
    /// The required-fields slice of TweetUnviewable — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetUnviewable as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type TweetUnviewable = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetUnviewable {
