...
module {
    ...
    public module JSON {
        ...
        //   let req = { Get2LikesSample10StreamResponse.init { …required fields… } with someOpt = ?… };
        ...
        public func toCandidValue(value : Get2LikesSample10StreamResponse) : Candid.Candid {
        ...
        public func fromCandidValue(candid : Candid.Candid) : ?Get2LikesSample10StreamResponse =
            switch (candid) {
                case (#Record(fields)) {
