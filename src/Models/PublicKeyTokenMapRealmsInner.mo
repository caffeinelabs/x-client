...
module {
    /// The required-fields slice of PublicKeyTokenMapRealmsInner — what `init` consumes.
    ...
    // it's an internal scaffold so we can express PublicKeyTokenMapRealmsInner as an
    ...
    public type PublicKeyTokenMapRealmsInner = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : PublicKeyTokenMapRealmsInner {
