...
module {
    /// The required-fields slice of ChatMediaUploadFinalizeResponseData — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ChatMediaUploadFinalizeResponseData as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type ChatMediaUploadFinalizeResponseData = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ChatMediaUploadFinalizeResponseData {
