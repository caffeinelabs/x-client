...
module {
    /// The required-fields slice of Get2ComplianceJobsIdResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express Get2ComplianceJobsIdResponse as an
    ...
    public type Get2ComplianceJobsIdResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : Get2ComplianceJobsIdResponse {
