...
module {
    /// The required-fields slice of BookmarkFoldersResponseDataInner — what `init` consumes.
    ...
    // it's an internal scaffold so we can express BookmarkFoldersResponseDataInner as an
    ...
    public type BookmarkFoldersResponseDataInner = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : BookmarkFoldersResponseDataInner {
