...
module {
    ...
    public type Get2UsersIdFollowingResponse = {
        data : ?[User];
        errors : ?[Problem];
        includes : ?Expansions;
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer Get2UsersIdFollowingResponse type
        public type JSON = {
            data : ?[User];
            errors : ?[Problem];
            includes : ?Expansions;
        ...
        public func toJSON(value : Get2UsersIdFollowingResponse) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?Get2UsersIdFollowingResponse = ?json;
    }
}
