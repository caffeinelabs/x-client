...
module {
    /// The required-fields slice of Get2UsersByUsernameUsernameResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express Get2UsersByUsernameUsernameResponse as an
    ...
    public type Get2UsersByUsernameUsernameResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : Get2UsersByUsernameUsernameResponse {
