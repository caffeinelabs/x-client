...
module {
    /// The required-fields slice of ContextAnnotation — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ContextAnnotation as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type ContextAnnotation = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ContextAnnotation {
