...
module {
    /// The required-fields slice of TweetCreateResponseData — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetCreateResponseData as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type TweetCreateResponseData = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetCreateResponseData {
