...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer Get2UsersIdLikedTweetsResponse type
        public type JSON = {
            data : ?[Tweet];
            errors : ?[Problem];
            includes : ?Expansions;
        ...
        public func toJSON(value : Get2UsersIdLikedTweetsResponse) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?Get2UsersIdLikedTweetsResponse = ?json;
    }
}
