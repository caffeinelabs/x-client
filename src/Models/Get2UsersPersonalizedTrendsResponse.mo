...
module {
    /// The required-fields slice of Get2UsersPersonalizedTrendsResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express Get2UsersPersonalizedTrendsResponse as an
    ...
    public type Get2UsersPersonalizedTrendsResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : Get2UsersPersonalizedTrendsResponse {
