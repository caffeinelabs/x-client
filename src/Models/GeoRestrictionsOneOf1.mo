...
module {
    /// The required-fields slice of GeoRestrictionsOneOf1 — what `init` consumes.
    ...
    // it's an internal scaffold so we can express GeoRestrictionsOneOf1 as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type GeoRestrictionsOneOf1 = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : GeoRestrictionsOneOf1 {
