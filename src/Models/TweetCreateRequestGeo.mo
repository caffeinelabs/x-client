...
module {
    /// The required-fields slice of TweetCreateRequestGeo — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetCreateRequestGeo as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        place_id : ?Text;
    };

    public type TweetCreateRequestGeo = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetCreateRequestGeo {
