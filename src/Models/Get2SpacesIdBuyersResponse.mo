...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer Get2SpacesIdBuyersResponse type
        public type JSON = {
            data : ?[User];
            errors : ?[Problem];
            includes : ?Expansions;
        ...
        public func toJSON(value : Get2SpacesIdBuyersResponse) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?Get2SpacesIdBuyersResponse = ?json;
    }
}
