...
module {
    /// The required-fields slice of SubscriptionsCreateResponseData — what `init` consumes.
    ...
    // it's an internal scaffold so we can express SubscriptionsCreateResponseData as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        subscribed : ?Bool;
    };

    public type SubscriptionsCreateResponseData = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : SubscriptionsCreateResponseData {
