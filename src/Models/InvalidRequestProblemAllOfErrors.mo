...
module {
    /// The required-fields slice of InvalidRequestProblemAllOfErrors — what `init` consumes.
    ...
    // it's an internal scaffold so we can express InvalidRequestProblemAllOfErrors as an
    ...
    public type InvalidRequestProblemAllOfErrors = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : InvalidRequestProblemAllOfErrors {
