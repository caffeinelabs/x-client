...
module {
    /// The required-fields slice of MediaUploadAppendRequestAnyOf1 — what `init` consumes.
    ...
    // it's an internal scaffold so we can express MediaUploadAppendRequestAnyOf1 as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type MediaUploadAppendRequestAnyOf1 = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : MediaUploadAppendRequestAnyOf1 {
