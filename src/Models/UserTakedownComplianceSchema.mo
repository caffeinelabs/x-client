...
module {
    /// The required-fields slice of UserTakedownComplianceSchema — what `init` consumes.
    ...
    // it's an internal scaffold so we can express UserTakedownComplianceSchema as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type UserTakedownComplianceSchema = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : UserTakedownComplianceSchema {
