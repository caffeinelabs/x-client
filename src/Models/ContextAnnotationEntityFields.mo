...
module {
    /// The required-fields slice of ContextAnnotationEntityFields — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ContextAnnotationEntityFields as an
    ...
    public type ContextAnnotationEntityFields = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ContextAnnotationEntityFields {
