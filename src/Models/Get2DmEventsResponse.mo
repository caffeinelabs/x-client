...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer Get2DmEventsResponse type
        public type JSON = {
            data : ?[DmEvent];
            errors : ?[Problem];
            includes : ?Expansions;
        ...
        public func toJSON(value : Get2DmEventsResponse) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?Get2DmEventsResponse = ?json;
    }
}
