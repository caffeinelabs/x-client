...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer VideoAllOfOrganicMetrics type
        public type JSON = {
            playback_0_count : ?Int;
            playback_100_count : ?Int;
            playback_25_count : ?Int;
        ...
        public func toJSON(value : VideoAllOfOrganicMetrics) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?VideoAllOfOrganicMetrics = ?json;
    }
}
