...
module {
    /// The required-fields slice of FollowActivityResponsePayload — what `init` consumes.
    ...
    // it's an internal scaffold so we can express FollowActivityResponsePayload as an
    ...
    public type FollowActivityResponsePayload = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : FollowActivityResponsePayload {
