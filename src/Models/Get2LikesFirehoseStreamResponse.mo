...
module {
    /// The required-fields slice of Get2LikesFirehoseStreamResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express Get2LikesFirehoseStreamResponse as an
    ...
    public type Get2LikesFirehoseStreamResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : Get2LikesFirehoseStreamResponse {
