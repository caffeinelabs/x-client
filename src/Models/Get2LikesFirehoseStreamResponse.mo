...
module {
    ...
    public module JSON {
        ...
        // Named "JSON" to avoid shadowing the outer Get2LikesFirehoseStreamResponse type
        public type JSON = {
            data : ?LikeWithTweetAuthor;
            errors : ?[Problem];
            includes : ?Expansions;
        ...
        public func toJSON(value : Get2LikesFirehoseStreamResponse) : JSON = value;

        // Convert JSON-facing Motoko type to User-facing type
        public func fromJSON(json : JSON) : ?Get2LikesFirehoseStreamResponse = ?json;
    }
}
