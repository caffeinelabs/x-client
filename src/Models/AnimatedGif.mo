...
module {
    /// The required-fields slice of AnimatedGif — what `init` consumes.
    ...
    // it's an internal scaffold so we can express AnimatedGif as an
    ...
    public type AnimatedGif = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : AnimatedGif {
