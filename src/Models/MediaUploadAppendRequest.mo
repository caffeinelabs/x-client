...
module {
    /// The required-fields slice of MediaUploadAppendRequest — what `init` consumes.
    ...
    // it's an internal scaffold so we can express MediaUploadAppendRequest as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type MediaUploadAppendRequest = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : MediaUploadAppendRequest {
