...
module {
    /// The required-fields slice of TweetHideResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetHideResponse as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        data : ?TweetHideResponseData;
    };

    public type TweetHideResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetHideResponse {
