...
module {
    /// The required-fields slice of ListUpdateResponseData — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ListUpdateResponseData as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        updated : ?Bool;
    };

    public type ListUpdateResponseData = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ListUpdateResponseData {
