...
module {
    /// The required-fields slice of TweetHideResponseData — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetHideResponseData as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        hidden : ?Bool;
    };

    public type TweetHideResponseData = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetHideResponseData {
