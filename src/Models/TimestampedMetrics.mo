...
module {
    /// The required-fields slice of TimestampedMetrics — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TimestampedMetrics as an
    ...
    public type TimestampedMetrics = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TimestampedMetrics {
