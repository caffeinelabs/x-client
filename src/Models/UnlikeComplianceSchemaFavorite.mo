...
module {
    /// The required-fields slice of UnlikeComplianceSchemaFavorite — what `init` consumes.
    ...
    // it's an internal scaffold so we can express UnlikeComplianceSchemaFavorite as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type UnlikeComplianceSchemaFavorite = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : UnlikeComplianceSchemaFavorite {
