...
module {
    /// The required-fields slice of Get2UsersIdMutingResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express Get2UsersIdMutingResponse as an
    ...
    public type Get2UsersIdMutingResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : Get2UsersIdMutingResponse {
        ...
        public func fromCandidValue(candid : Candid.Candid) : ?Get2UsersIdMutingResponse =
            switch (candid) {
                case (#Record(fields)) {
