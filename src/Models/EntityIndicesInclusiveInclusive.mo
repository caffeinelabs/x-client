...
module {
    /// The required-fields slice of EntityIndicesInclusiveInclusive — what `init` consumes.
    ...
    // it's an internal scaffold so we can express EntityIndicesInclusiveInclusive as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type EntityIndicesInclusiveInclusive = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : EntityIndicesInclusiveInclusive {
