...
module {
    /// The required-fields slice of DmEventReferencedTweetsInner — what `init` consumes.
    ...
    // it's an internal scaffold so we can express DmEventReferencedTweetsInner as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type DmEventReferencedTweetsInner = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : DmEventReferencedTweetsInner {
