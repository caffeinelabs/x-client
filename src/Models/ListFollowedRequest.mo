...
module {
    /// The required-fields slice of ListFollowedRequest — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ListFollowedRequest as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type ListFollowedRequest = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ListFollowedRequest {
