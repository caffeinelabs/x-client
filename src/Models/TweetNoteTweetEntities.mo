...
module {
    /// The required-fields slice of TweetNoteTweetEntities — what `init` consumes.
    ...
    // it's an internal scaffold so we can express TweetNoteTweetEntities as an
    ...
    public type TweetNoteTweetEntities = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : TweetNoteTweetEntities {
