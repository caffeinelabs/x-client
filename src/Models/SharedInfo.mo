...
module {
    /// The required-fields slice of SharedInfo — what `init` consumes.
    ...
    // it's an internal scaffold so we can express SharedInfo as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type SharedInfo = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : SharedInfo {
