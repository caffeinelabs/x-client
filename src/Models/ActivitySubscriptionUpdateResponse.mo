...
module {
    /// The required-fields slice of ActivitySubscriptionUpdateResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express ActivitySubscriptionUpdateResponse as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        data : ?ActivitySubscriptionUpdateResponseData;
    };

    public type ActivitySubscriptionUpdateResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : ActivitySubscriptionUpdateResponse {
