...
module {
    /// The required-fields slice of EngagementMeasurementMetricsTimeSeriesInnerValueTimestamp — what `init` consumes.
    ...
    // it's an internal scaffold so we can express EngagementMeasurementMetricsTimeSeriesInnerValueTimestamp as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
        iso8601_time : ?Text;
    };

    public type EngagementMeasurementMetricsTimeSeriesInnerValueTimestamp = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : EngagementMeasurementMetricsTimeSeriesInnerValueTimestamp {
