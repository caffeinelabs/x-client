...
module {
    /// The required-fields slice of UserComplianceSchema — what `init` consumes.
    ...
    // it's an internal scaffold so we can express UserComplianceSchema as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type UserComplianceSchema = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : UserComplianceSchema {
