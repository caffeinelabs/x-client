...
module {
    /// The required-fields slice of UserComplianceStreamResponseOneOf — what `init` consumes.
    ...
    // it's an internal scaffold so we can express UserComplianceStreamResponseOneOf as an
    // `and`-intersection and keep `init` from listing every optional explicitly.
    type Optional = {
    };

    public type UserComplianceStreamResponseOneOf = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : UserComplianceStreamResponseOneOf {
