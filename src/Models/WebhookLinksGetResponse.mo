...
module {
    /// The required-fields slice of WebhookLinksGetResponse — what `init` consumes.
    ...
    // it's an internal scaffold so we can express WebhookLinksGetResponse as an
    ...
    public type WebhookLinksGetResponse = Required and Optional;
    ...
    public module JSON {
        ...
        public func init(required : Required) : WebhookLinksGetResponse {
